...
export function TodayEntriesList({
  ...
  const summary = useMemo(() => {
    ...
    const label = Object.entries(totals)
      ...
      .join(" · ");
    return label || "—";
  }, [entries, formatMoney, parseAmount]);
  ...
  return (
    <div ref={tableRef} className="today-panel" data-section="today-inline-ledger">
        ...
        <table className="today-inline-table">
          ...
          <tbody>
            {entries.map((entry) => (
              ...
              >
                <td className="today-inline-table__category">
