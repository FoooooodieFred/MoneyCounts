          ...
          <section className="card travel-card">
            ...
            {!travelState.active && (
              <div className="travel-setup-grid">
                <label className="travel-setup-grid__name">
                  旅游账单名称
                  <input
                ...
                <div className="travel-setup-grid__end">
            ...
            {travelState.active && (
              <div className="travel-bill">
                ...
                >
                  <div className="travel-natural-entry__copy">
                  ...
                  <label className="travel-natural-entry__field">
