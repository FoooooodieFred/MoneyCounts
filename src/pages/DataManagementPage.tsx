...
export function DataManagementPage({
  ...
  return (
    ...
    >
      <section className="page-hero data-hero" data-section="data-hero">
        <div>
      ...
      <section className="card data-management-card" data-section="data-csv">
      ...
      <section className="card data-management-card data-management-card--danger" data-section="data-clear">
        <div className="card-heading">
          <div>
